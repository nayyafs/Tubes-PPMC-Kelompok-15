...
int main() {
    ...
    unsigned char plaintext[100] = "50 Shade  Of gray";
...
// int main() {
//     unsigned char key[CRYPTO_KEYBYTES] = "WeLovePMC";
//     unsigned char nonce[CRYPTO_NPUBBYTES] = "1234567890123456";
//     unsigned char plaintext[100] = "ArigatouKelompok15";
//     unsigned char ciphertext[100 + CRYPTO_ABYTES];
//     unsigned char decrypted[100];
//     unsigned char ad[100] = "AssociatedData";
//     unsigned long long ciphertext_len, decrypted_len;
